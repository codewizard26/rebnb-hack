  ...
  return (
    <header className="sticky top-0 z-40 w-full border-b bg-background/80 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="mx-auto flex h-16 w-full max-w-none items-center gap-3 px-4">
        <Link
          href="/"
          className="bg-gradient-to-r from-indigo-500 to-pink-500 bg-clip-text text-lg font-bold text-transparent tracking-tight"
        >
          ReAirbnb
        </Link>
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          <Button
            onClick={onSearch}
            className="hidden sm:inline-flex bg-gradient-to-r from-indigo-500 to-pink-500 text-white shadow hover:shadow-lg"
          >
            Search
          </Button>
          <ModeToggle />
